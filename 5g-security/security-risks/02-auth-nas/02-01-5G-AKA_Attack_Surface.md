...
- **중계/재전송 가능성**: 인증 메시지 자체가 유효하더라도, 이를 다른 위치/시점에 중계하거나 재전송하는 공격(relay/replay)이 시도될 수 있다. (연관: [02-04 Authentication Relay](02-04-Authentication_Relay.md))
- **자원 소모**: 인증은 계산·시그널링 비용이 있어, 대량 인증 요청으로 자원을 고갈시키는 DoS가 가능하다. (연관: [02-03 Authentication DoS](02-03-Authentication_DoS.md))
...
- SUCI 사용으로 인증 개시 시 식별자 노출 최소화 (연관: [01-04 SUCI Misconfiguration](../01-ue-privacy/01-04-SUCI_Misconfiguration.md))
- 다운그레이드/재전송 방지 메커니즘 적용 (연관: [02-07 NAS Security Downgrade](02-07-NAS_Security_Downgrade.md))

**탐지·운영 통제**
- 인증 실패율·요청률 모니터링으로 DoS/중계 이상 징후 탐지
- 인증 컨텍스트 수명·동기화 관리 (연관: [02-06 Security Context Desynchronization](02-06-Security_Context_Desynchronization.md))
...
> 상세 정의는 [12. 3GPP / O-RAN 표준](../../references/3gpp-standards/README.md) 참조. 5G-AKA 인증 절차와 키 파생은 TS 33.501에 정의된다.

## 8. 관련 US 가이드라인

US-1

> 상세 정의는 [14. US 보안 가이드라인](../../references/nist-series/README.md) 참조. US-1(NIST CSWP 36 시리즈)은 5G 보안 기능의 구현·검증 관점을 다룬다.

## 9. 관련 EU 가이드라인

EU-3

> 상세 정의는 [13. EU 보안 프레임워크](../../references/enisa-framework/README.md) 참조. EU-3(ENISA Security in 5G Specifications)은 3GPP 보안 규격상의 인증 관련 통제를 해설한다.

## 10. 참조 논문

P1, P2

> 상세 정의는 [15. 참조 논문](../../references/research-papers/README.md) 참조. P1(5G SA 공격 survey)·P2(5G 보안 survey)가 인증 관련 공격을 다룬다.

---

## 관련 이슈
- [02-03 Authentication DoS](02-03-Authentication_DoS.md)
- [02-04 Authentication Relay](02-04-Authentication_Relay.md)
- [02-06 Security Context Desynchronization](02-06-Security_Context_Desynchronization.md)
- [01-01 5G Key Hierarchy](../../fundamentals/01-01-5G_Key_Hierarchy.md)
