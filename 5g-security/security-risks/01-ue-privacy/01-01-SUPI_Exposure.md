...
- 관련: [01-03 SUCI Null Scheme](01-03-SUCI_Null_Scheme.md), [01-04 SUCI Misconfiguration](01-04-SUCI_Misconfiguration.md), [01-05 False Base Station](01-05-False_Base_Station.md)
...
> 상세 정의는 [12. 3GPP / O-RAN 표준](../../references/3gpp-standards/README.md) 참조.
>
...
> 상세 정의는 [14. US 보안 가이드라인](../../references/nist-series/README.md) 참조. US-2(NIST CSWP 36A)는 SUCI를 통한 가입자 식별자 보호를 다룬다.
>
...
> 상세 정의는 [13. EU 보안 프레임워크](../../references/enisa-framework/README.md) 참조. EU-1(ENISA 5G Threat Landscape)은 가입자 식별자 노출 및 추적을 5G 위협 지형의 한 항목으로 다룬다.

## 10. 참조 논문

P1, P2

> 상세 정의는 [15. 참조 논문](../../references/research-papers/README.md) 참조. 5G SA 공격 표면 분석 논문에서 SUPI/SUCI 노출 및 식별자 추적 계열 공격을 다룬다.

---

## 관련 이슈
- [01-02 IMSI-SUPI Catching](01-02-IMSI-SUPI_Catching.md)
- [01-03 SUCI Null Scheme](01-03-SUCI_Null_Scheme.md)
- [01-04 SUCI Misconfiguration](01-04-SUCI_Misconfiguration.md)
- [01-05 False Base Station](01-05-False_Base_Station.md)
